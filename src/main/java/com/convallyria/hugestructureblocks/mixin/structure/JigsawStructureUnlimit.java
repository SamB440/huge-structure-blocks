...
//    @Final
//    @Mutable
//    public static MapCodec<JigsawStructure> CODEC = RecordCodecBuilder.<JigsawStructure>mapCodec((instance) -> instance.group(configCodecBuilder(instance), StructurePool.REGISTRY_CODEC.fieldOf("start_pool").forGetter((structure) -> structure.startPool), Identifier.CODEC.optionalFieldOf("start_jigsaw_name").forGetter((structure) -> structure.startJigsawName), Codec.INT.fieldOf("size").forGetter((structure) -> structure.size), HeightProvider.CODEC.fieldOf("start_height").forGetter((structure) -> structure.startHeight), Codec.BOOL.fieldOf("use_expansion_hack").forGetter((structure) -> structure.useExpansionHack), Heightmap.Type.CODEC.optionalFieldOf("project_start_to_heightmap").forGetter((structure) -> structure.projectStartToHeightmap), Codec.INT.fieldOf("max_distance_from_center").forGetter((structure) -> structure.maxDistanceFromCenter), Codec.list(StructurePoolAliasBinding.CODEC).optionalFieldOf("pool_aliases", List.of()).forGetter((structure) -> ((JigsawStructureUnlimit) (Object) structure).getPoolAliasBindings()), DimensionPadding.CODEC.optionalFieldOf("dimension_padding", JigsawStructure.DEFAULT_DIMENSION_PADDING).forGetter((structure) -> ((JigsawStructureUnlimit) (Object) structure).getDimensionPadding()), StructureLiquidSettings.codec.optionalFieldOf("liquid_settings", JigsawStructure.DEFAULT_LIQUID_SETTINGS).forGetter((jigsawStructure) -> ((JigsawStructureUnlimit) (Object) jigsawStructure).getLiquidSettings())).apply(instance, JigsawStructure::new)).validate(JigsawStructure::validate);
